---
title: "Motion Sensor Light Wont Turn Off? 7 Quick Fixes"
slug: "motion-sensor-light-stays-on"
description: "Fix motion lights stuck on with these 7 simple solutions. Adjust sensitivity, check obstructions, and reset sensors to reduce wasted electricity."
date: 2024-01-20
lastmod: 2024-03-10
...
{{< faq question="Why does my motion light stay on all the time?" >}}
The most common reasons are sensitivity set too high, obstructions in the detection zone, or the timer setting at maximum duration. Start by adjusting the sensitivity dial to a lower setting.
{{< /faq >}}

{{< faq question="Can weather cause motion lights to stay on?" >}}
Yes. Wind can move branches, and rain can change reflections. Lower sensitivity and remove moving objects from the detection zone.
{{< /faq >}}

{{< faq question="When should I replace a motion sensor?" >}}
